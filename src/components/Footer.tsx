  ...
  return (
    <div className="text-green-500">
      ...
      <div className="flex items-center justify-evenly py-6 text-base md:text-lg">
        <span>Facebook</span> <span>Twitter</span> <span> <a href="https://www.instagram.com/adforerunneragro?igsh=a2trMGhybHY5djlq&utm_source=ig_contact_invite">Instagram</a></span>{" "}
        <span></span>
      </div>
