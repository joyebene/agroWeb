...
const Hero = () => {
  ...
  return (
    <div className="relative h-[calc(100vh-6rem)] mt-[8rem] overflow-hidden">
      ...
      <div className="absolute inset-0  bg-green-500 bg-opacity-70 flex flex-col md:justify-center md:items-center justify-center items-start pl-6 gap-4">
        <div>
          ...
          <h1
            className={`uppercase font-bold text-4xl md:text:5xl lg:text-6xl text-balance text-black leading-tight tracking-tight transition-opacity duration-1000 ${
        ...
        <h2 className="bg-inherit text-black md:text-xl lg:text-2xl md:text-center text-xl tracking-tight leading-tight">
