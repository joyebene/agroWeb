    ...
    <div className="py-12 w-full mt-7">
      ...
      <div className="flex flex-col md:flex-row md:items-stretch items-center justify-center mt-6 px-6 md:px-10">
        <div className=" p-4 text-center bg-green-500 m-5 rounded-2xl shadow-xl text-black">
          ...
          <p className="text-black">We manage and execute a variety of contracts related to agricultural projects and provide essential merchandise to support farming operations.</p>
        </div>
        <div className="p-4 text-center bg-green-500 m-5 rounded-2xl shadow-xl text-black">
        <Image src="/icon7.png" alt="img" width={100} height={100} className="mx-auto mb-2 mt-1"/>
          ...
          <p className="text-black">We cultivate success through high-yielding crops, strategic market analysis, and cost-effetive operations, ensuring sustainable profits for our stakeholders.</p>
        </div>
        <div className="p-4 text-center bg-green-500 m-5 rounded-2xl shadow-xl text-black">
          ...
          <p className="text-black">We offer a wide range of agro-allied products including seeds, fertilizers, and pest control solutions. </p>
        </div>
        <div className="p-4 text-center bg-green-500 m-5 rounded-2xl shadow-xl text-black">
          ...
          <p className="text-black">Our expertise in logistics and trade will ensure handling of imports and exports, contributing to a robust supply chain. </p>
        </div>
      </div>
    </div>
